...
class PraticienController extends Controller
{
    ...
    public function getPraticienAction(Request $request, ParamFetcher $paramFetcher)
    {
        // INIT RESPONSE
        $repo=$this->getDoctrine()->getRepository('MainBundle:Praticien');
        $praticien=$repo->findAll();
    ...
    public function getOnepraticienAction($id)
    {
        $em = $this->getDoctrine()->getManager();

        $praticien = $em->getRepository('MainBundle:Praticien')->findOneBy(array("id"=>$id));
